<form method="post" action="{{ route('admin.dashboard.store') }}">
    ...
    <input type="text" id="f-image" name="image">

    <div class="row">
        <div class="small-12 medium-6">
            <label for="f-button_label">Button label</label>
            <input type="text" id="f-button_label" name="button_label">
        </div>
        <div class="small-12 medium-6">
            <label for="f-button_url">Button URL</label>
            <input type="text" id="f-button_url" name="button_url">
        </div>
    </div>

    <label for="f-content">Content</label>
    <textarea name="content" id="f-content" cols="30" rows="10"></textarea>
</form>